...
const claude = new sdk_1.default({ apiKey: config_1.config.anthropicApiKey });
async function generarRespuesta(textoCliente, configNegocio, historial) {
...
- Habla natural y cálido, no robótico — pero sin inventar información`;
    ...
    const costoUsd = respuesta.usage.input_tokens * 0.000003 +
