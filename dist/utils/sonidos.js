...
exports.AMBIENTE_ACTIVO = exports.MS_POR_FRAME = exports.FRAMES_AMBIENTE = exports.FRAMES_TECLEO = void 0;
...
function generarTecleo(durSegundos, seed) {
    const rand = rng(seed);
...
function generarAmbiente(durSegundos, seed) {
    const rand = rng(seed);
    const total = Math.floor(durSegundos * SAMPLE_RATE);
...
exports.FRAMES_TECLEO = pcmAFrames(generarTecleo(6, 20260717));
exports.FRAMES_AMBIENTE = pcmAFrames(generarAmbiente(8, 999331));
exports.MS_POR_FRAME = 20;
...
exports.AMBIENTE_ACTIVO = (process.env.AMBIENTE_LLAMADA || "").toLowerCase() === "on";
//# sourceMappingURL=sonidos.js.map